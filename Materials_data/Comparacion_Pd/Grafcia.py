...
data = np.loadtxt("dispPd_alloy.dat")
"""""
data1 = np.loadtxt("dispPd_eam.dat")
data3 = np.loadtxt("dispPd_meam.dat")
"""""
data4 = pd.read_csv("datosPd_exp.csv")
data6 = pd.read_csv("datosPd_exp1.csv")
data7 = pd.read_csv("datosPd_exp2.csv")
data8 = pd.read_csv("datosPd_exp3.csv")
...
plt.plot(x3,y9,"--", linewidth=0.7, color="royalblue", label="MEAM")
plt.plot(x3,y10,"--", linewidth=0.7, color="royalblue")
plt.plot(x3,y11,"--", linewidth=0.7, color="royalblue")
"""""
plt.legend()
...
plt.ylim([0,7])
plt.xticks([])
plt.savefig('dispPd.png', dpi=1000)
plt.close()