...
data = np.loadtxt("dispPt_alloy.dat")
data1 = np.loadtxt("dispPt_eam.dat")
data3 = np.loadtxt("dispPt_meam.dat")

data4 = pd.read_csv("datosPt_exp.csv")
data6 = pd.read_csv("datosPt_exp1.csv")
data7 = pd.read_csv("datosPt_exp2.csv")
data8 = pd.read_csv("datosPt_exp3.csv")
